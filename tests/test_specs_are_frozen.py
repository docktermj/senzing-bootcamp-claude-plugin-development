...
still write spec files -- `/unattended-spec-loop` (#51) and `/delegate-to-mcp-server` (no
issue yet). `/feedback-to-issues` files GitHub issues as of #49, and `/implement-spec` was
retired under #60.
